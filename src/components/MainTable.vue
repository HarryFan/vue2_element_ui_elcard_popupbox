<template>
  <div>
    <!-- 學生詳情彈出框元件 -->
    <student-details-dialog :visible.sync="showDetails" :student="currentStudent" @close-dialog="showDetails = false">
    </student-details-dialog>
    <!-- 學生列表表格 -->
    <!-- 主表格 -->
    <el-table :data="students" border style="width: 100%">
      <!-- 循環渲染表格列 -->
      <el-table-column v-for="(column, index) in mainTableColumns" :key="index" :prop="column.prop"
